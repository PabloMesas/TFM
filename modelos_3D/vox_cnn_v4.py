...
def VoxCNN_V4(
    ...
    x = layers.Conv3D(
        8, (3, 3, 3), activation='relu', padding='same', name='block1_conv3')(x)
    ...
    x = layers.Conv3D(
        16, (3, 3, 3), activation='relu', padding='same', name='block2_conv3')(x)
    ...
    # # Block 5
    x = layers.Conv3D(
        128, (3, 3, 3), activation='relu', padding='same', name='block5_conv1')(x)
    x = layers.Conv3D(
        128, (3, 3, 3), activation='relu', padding='same', name='block5_conv2')(x)
    x = layers.Conv3D(
        128, (3, 3, 3), activation='relu', padding='same', name='block5_conv3')(x)
    ...
    # Create model.
    model = Model(img_input, x, name='VoxCNN_V4')
