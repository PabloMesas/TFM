...
def voxCNN_pseudo3D_V2(
   ...
   # Block 1
    ...
    x = layers.Conv2D(
        8, (3, 3), activation='relu', padding='same', name='block1_conv3')(x)
    ...
    # x = layers.Conv2D(
    #     16, (3, 3), activation='relu', padding='same', name='block2_conv3')(x)
    ...
    # Create model.
    model = Model(img_input, x, name='VoxCNN_pseudoRGB_V2')
