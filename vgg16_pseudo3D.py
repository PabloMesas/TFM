...
def brainVGG16_pseudo3D(
    ...
    if pretrained:
        model1 = VGG16(include_top=False, weights="imagenet", input_shape=(input_shape[0], input_shape[1], 3))
    else:
        model1 = VGG16(include_top=False, weights=None, input_shape=(input_shape[0], input_shape[1], 3))
    ...
    model1.summary()
    conv = model1.get_layer('block4_pool')
    ...
    model = Model(img_input, x, name='VGG16_pseudoRGB')
    model.summary()
